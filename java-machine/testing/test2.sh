  ...
  do
   case "${opt}" in
     ...
     c) APPDYNAMICS_CONTROLLER_HOST_NAME=${OPTARG}
        ...
        APPDYNAMICS_AGENT_ACCOUNT_NAME=`echo ${APPDYNAMICS_CONTROLLER_HOST_NAME} | sed 's/\.saas\.appdynamics\.com//' ` 
        echo "APPDYNAMICS_AGENT_ACCOUNT_NAME=${APPDYNAMICS_AGENT_ACCOUNT_NAME}"
        ;;
...
sed -i.bak "s/APPDYNAMICS_AGENT_ACCOUNT_NAME:/APPDYNAMICS_AGENT_ACCOUNT_NAME: \"$APPDYNAMICS_AGENT_ACCOUNT_NAME\"/" ./.ebextensions/appd.config
